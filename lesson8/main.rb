...
class Main
  ...
  def create_train
    begin
      ...
      raise 'Train with this number already exist. Try again.' if Train.find(number)
  ...
  def remove_station_from_route(route)
    raise "You can't remove any station." if route.stations.count <= 2
  ...
  def take_a_seat
    ...
    begin
      raise 'Wrong carriage type. Try again.' unless carriage.type == 'passenger'
  ...
  def place_volume
    ...
    begin
      ...
      raise 'Wrong carriage type. Try again.' unless carriage.type == 'cargo'
